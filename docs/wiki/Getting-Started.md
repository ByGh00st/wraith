...
Get the packages and checksums from the **[v1.4.4 release](https://github.com/ByGh00st/wraith/releases/tag/v1.4.4)**, configure the signed APT repository once, or let the installer select the latest stable version for your system.
...
Manual Debian installation for v1.4.4:

```bash
wget https://github.com/ByGh00st/wraith/releases/download/v1.4.4/wraith_1.4.4_amd64.deb
wget https://github.com/ByGh00st/wraith/releases/download/v1.4.4/SHA256SUMS.txt
sha256sum --ignore-missing --check SHA256SUMS.txt
sudo apt install ./wraith_1.4.4_amd64.deb
wraith --version
```
