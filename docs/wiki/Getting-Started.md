...
Get the packages and checksums from the **[v1.4.5 release](https://github.com/ByGh00st/wraith/releases/tag/v1.4.5)**, configure the signed APT repository once, or let the installer select the latest stable version for your system.
...
Manual Debian installation for v1.4.5:
