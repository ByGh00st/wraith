...
pub const HARDWARE_SHIELD_PREFERENCES: &[(&str, &str)] = &[
    ...
    // --- 8. LOCALE, TIMEZONE & NETWORK PROXIES ---
    // Force UTC timezone regardless of physical location
    ("javascript.use_us_english_locale", "true"),
    // Enforce Tor SOCKS5 with remote DNS resolution
...
pub fn remove_hardware_and_font_shield() -> Result<usize> {
    ...
    info!("Removed hardware and font shield from {removed_count} profiles");
    Ok(removed_count)
}
